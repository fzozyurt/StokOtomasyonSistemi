...
namespace Otomasyon.Fonksiyonlar
{
    class Formlar
    {
        ...
        public int Cari_Sube(bool Secim = false)
        {
            Modul_Cari.frmSube frm = new Modul_Cari.frmSube();
            if (Secim) frm.Secim = Secim;
            frm.ShowDialog();
            return AnaForm.Aktarma;
        }

        public int Cari_Yetkili_List(bool Secim = false)
        {
            Modul_Cari.frmYetkili_List frm = new Modul_Cari.frmYetkili_List();
            if (Secim) frm.Secim = Secim;
            frm.ShowDialog();
            return AnaForm.Aktarma;
        }
        ...
        public int Cariiliski(bool Secim = false)
        {
            Modul_Cari.frmIlıski frm = new Modul_Cari.frmIlıski();
            if (Secim) frm.Secim = Secim;
            frm.ShowDialog();
            return AnaForm.Aktarma;
        }
        ...
        #region Teklif
        public void YeniTeklif(bool Ac = false, int ID = -1, bool Irsaliye = false)
        {
            Modul_Teklif.frmTeklif frm = new Modul_Teklif.frmTeklif(/*Ac, ID,Irsaliye*/);
            frm.MdiParent = AnaForm.ActiveForm;
            frm.Show();
        }
        #endregion
        ...
        {
            Modul_Personell.frmPersonelKaydi frm = new Modul_Personell.frmPersonelKaydi();
            frm.Show();
        }
